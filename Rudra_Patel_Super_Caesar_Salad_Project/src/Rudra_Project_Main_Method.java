        ...
        do{
            ...
            if (choice_1or2==1||choice_1or2==2) {
                ...
                if (choice_1or2==2) {
                    ...
                    do {
                        ...
                        if (decipher_choice == 1 || decipher_choice == 2) {
                            if (decipher_choice == 1) {
                                ...
                                Rudra_Project_Decipher_the_EncipherText_.decipher_the_plaintext_(plainText,shift_key,Key_Word);
                            } else {
                    ...
                    Key_Word = Rudra_Project_Cipher_Keyword_Input.Keyword();
                    int[] shift_key = Rudra_Project_Shift_Keyword.Shift_Key(Key_Word);
                    Main_Answer = Rudra_Project_Encipher_the_plaintext_.encipher_the_plaintext_(plainText,shift_key,Key_Word);
